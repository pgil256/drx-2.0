...
Complements development/tests/unit/test_arduino_parse.py (handle_com parsing + v2 framing)
and development/tests/integration/test_arduino_comm.py (pty round-trips). These tests use a
