...
Usage:
    python development/tools/calibrate.py [--port /dev/serial0] [--dry-run]
...
_DEVICE = os.environ.get("KNEESPA_DEVICE_DIR", os.path.join(_PROJECT, "devices", "local"))
CONFIG_PATH_DEFAULT = os.environ.get(
    "KNEESPA_CONFIG_PATH", os.path.join(_DEVICE, "raspberry-pi", "config", "kneespa.cfg"),
)
