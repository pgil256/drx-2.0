...
Modes (run on the Pi with the KneeSpa app NOT running):
    ...
    python3 development/tools/lateral_pot_probe.py                 # rest, I12 move out, home
    python3 development/tools/lateral_pot_probe.py --pressure 10   # rest, tare, P10 (the
                                                       #   exact protocol-1
                                                       #   condition), stop, home
    python3 development/tools/lateral_pot_probe.py --pressure 10 --gpio
                                                       # same, with the Pi GPIO
                                                       #   lines driven exactly
                                                       #   as the app drives them
    python3 development/tools/lateral_pot_probe.py --watch 30      # watch only, no motion
    python3 development/tools/lateral_pot_probe.py --stop          # just send X and exit
    python3 development/tools/lateral_pot_probe.py --banner /dev/ttyACM0
