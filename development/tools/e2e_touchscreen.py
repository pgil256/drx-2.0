...
def parse_app_command(command: Optional[str]) -> List[str]:
    ...
    return [sys.executable, "-u", "runtime/raspberry-pi/main/kneespa.py", "--print-logs"]
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir", default="devices/local/raspberry-pi/logs/e2e", help="parent directory for run logs"
    )
    parser.add_argument(
        "--skip-initial-reset",
        action="store_true",
