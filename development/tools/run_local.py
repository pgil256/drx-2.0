...
Usage:
    python development/tools/run_local.py            # windowed GUI on your desktop
    QT_QPA_PLATFORM=offscreen python development/tools/run_local.py   # headless (CI/grab)
...
_MAIN = os.path.join(_ROOT, "runtime", "raspberry-pi", "main")
os.environ.setdefault("KNEESPA_DEVICE_DIR", os.path.join(_ROOT, "devices", "development"))
