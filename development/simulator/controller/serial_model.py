"""Reusable legacy controller double; physical simulation extends this model.

Extracted from development/tests/fixtures/fake_arduino.py. Timing defaults
remain accelerated for existing serial integration tests.
"""
import threading
import time
...
class ControllerModel:
    """Firmware protocol model independent of the serial endpoint."""
    ...
    def _write(self, data: str) -> None:
        """Deliver reply bytes through the endpoint supplied by a subclass."""
