...
(host-side clamps) and in runtime/arduino/motor/motor.ino (the authoritative firmware
...
CONSTANTS_PY = REPO_ROOT / "runtime" / "raspberry-pi" / "main" / "config" / "constants.py"
CONFIG_PY = REPO_ROOT / "runtime" / "raspberry-pi" / "main" / "config" / "config.py"
MOTOR_INO = REPO_ROOT / "runtime" / "arduino" / "motor" / "motor.ino"

# (constants.py name, motor.ino #define name)
PAIRS = [
    ("PRESSURE_MAX", "MAX_PRESSURE_LBS"),
    ("PRESSURE_WARNING_MAX", "PRESSURE_WARNING_LBS"),
    ("PRESSURE_TARGET_TOLERANCE", "PRESSURE_TARGET_TOLERANCE_LBS"),
    ("PRESSURE_OVERSHOOT_ALLOWANCE", "PRESSURE_OVERSHOOT_ALLOWANCE_LBS"),
    ...
    ("MOTOR_SPEED_MIN", "MOTOR_SPEED_MIN_PERCENT"),
    ("MOTOR_SPEED_MAX", "MOTOR_SPEED_MAX_PERCENT"),
]
